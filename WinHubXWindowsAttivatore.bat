...
if "%Sceltaattivazione%" == "2" ( goto :tsforge )
if "%Sceltaattivazione%" == "3" ( goto :kms38 )
if "%Sceltaattivazione%" == "4" ( goto :serverkms )
...
if %_actwin%==0 set fixes=%fixes% genuine-installation-media
...
call :dk_color2 %Blue% "Help - " %_Yellow% " tsforge#office-kms-host"
)
